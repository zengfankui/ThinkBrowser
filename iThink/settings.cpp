...
#else
    downloadsLocation->setText(QStandardPaths::writableLocation(QStandardPaths::DataLocation));
#endif
...
void SettingsDialog::loadFromSettings()
{
    ...
    QString defaultHome = QLatin1String("http://www.thinkbrowser.com");
    homeLineEdit->setText(settings.value(QLatin1String("主页"), defaultHome).toString());
    settings.endGroup();
